...
import papan from '../../asset/yiha.jpg'
...
function Masuk () {
  ...
  return (
    <div className="flex justify-end items-center min-h-screen bg-linear-to-t from-sky-300 to-indigo-500">
      <img src={papan} alt="yiha" className="w-full max-w-3xl mx-auto rounded-lg shadow-lg "/>
